        ...
        {currentIndex < photos.length ? (
          <>
            ...
            <div className="swipe-buttons absolute -bottom-32 left-0 right-0 flex justify-center items-center space-x-4 z-10 mt-8">
              ...
              <button 
                onClick={onInfoClick}
                className="w-12 h-12 flex items-center justify-center bg-white text-secondary rounded-full shadow-lg hover:bg-primary hover:text-white transition-colors"
              >
