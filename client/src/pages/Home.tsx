...
export default function Home() {
  ...
  return (
    <main className="max-w-md mx-auto min-h-[100dvh] flex flex-col">
      ...
      <header className="py-2 px-4 flex items-center justify-between">
        ...
        <a 
          ...
          className="flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full bg-white shadow-sm hover:bg-gray-100 text-gray-700 transition-colors"
